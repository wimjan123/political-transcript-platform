      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        <div className="relative bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Similar Segments</h3>
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
            {isLoading && (
              <div className="flex items-center justify-center py-12">
                ...
                <span className="ml-3 text-gray-600">Finding similar segments...</span>
              </div>
            )}
            ...
            {!isLoading && !error && similarSegments.length === 0 && (
              <div className="text-center py-12">
                ...
                <h4 className="mt-2 text-sm font-medium text-gray-900">No similar segments found</h4>
